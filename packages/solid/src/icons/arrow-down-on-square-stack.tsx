...
export interface ArrowDownOnSquareStackIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface ArrowDownOnSquareStackIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: ArrowDownOnSquareStackIconHandle) => void;
}
...
const ArrowDownOnSquareStackIcon = (rawProps: ArrowDownOnSquareStackIconProps) => {
