...
export interface DocumentIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface DocumentIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: DocumentIconHandle) => void;
}
...
const DocumentIcon = (rawProps: DocumentIconProps) => {
