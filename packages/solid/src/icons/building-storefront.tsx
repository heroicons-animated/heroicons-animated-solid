...
interface BuildingStorefrontIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: BuildingStorefrontIconHandle) => void;
}
...
const BuildingStorefrontIcon = (rawProps: BuildingStorefrontIconProps) => {
