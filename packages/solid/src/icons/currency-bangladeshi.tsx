...
interface CurrencyBangladeshiIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: CurrencyBangladeshiIconHandle) => void;
}
...
const CurrencyBangladeshiIcon = (rawProps: CurrencyBangladeshiIconProps) => {
