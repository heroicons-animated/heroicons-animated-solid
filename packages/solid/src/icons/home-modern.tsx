...
export interface HomeModernIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface HomeModernIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: HomeModernIconHandle) => void;
}
...
const HomeModernIcon = (rawProps: HomeModernIconProps) => {
