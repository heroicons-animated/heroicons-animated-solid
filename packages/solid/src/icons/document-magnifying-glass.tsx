...
interface DocumentMagnifyingGlassIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
...
const DocumentMagnifyingGlassIcon = (rawProps: DocumentMagnifyingGlassIconProps) => {
