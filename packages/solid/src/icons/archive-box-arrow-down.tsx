...
interface ArchiveBoxArrowDownIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: ArchiveBoxArrowDownIconHandle) => void;
}
...
const ArchiveBoxArrowDownIcon = (rawProps: ArchiveBoxArrowDownIconProps) => {
