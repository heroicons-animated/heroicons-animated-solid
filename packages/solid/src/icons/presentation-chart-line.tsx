...
interface PresentationChartLineIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: PresentationChartLineIconHandle) => void;
}
...
const PresentationChartLineIcon = (rawProps: PresentationChartLineIconProps) => {
