...
interface Cog6ToothIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: Cog6ToothIconHandle) => void;
}


const Cog6ToothIcon = (rawProps: Cog6ToothIconProps) => {
  ...
  return (
    ...
    >
      <Motion.svg
        animate={resolveValues({normal: {
                    rotate: 0,
                  },
                  animate: {
                    rotate: 180,
                  },}, variant())}
        transition={resolveTransition({normal: {
                    rotate: 0,
                  },
                  animate: {
                    rotate: 180,
                  },}, variant(), undefined, {type: "spring", stiffness: 50, damping: 10})}
                fill="none"
                height={local.size}
                stroke="currentColor"
