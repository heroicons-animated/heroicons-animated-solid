...
interface ServerStackIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: ServerStackIconHandle) => void;
}
...
const ServerStackIcon = (rawProps: ServerStackIconProps) => {
