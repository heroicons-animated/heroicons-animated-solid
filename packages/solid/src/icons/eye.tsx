  ...
  return (
    ...
    >
      <svg
              ...
              >
                <Motion.path
                  animate={resolveValues({normal: { scaleY: 1, opacity: 1 },
                    animate: { scaleY: [1, 0.1, 1], opacity: [1, 0.3, 1] },}, variant())}
                  transition={resolveTransition({normal: { scaleY: 1, opacity: 1 },
                    animate: { scaleY: [1, 0.1, 1], opacity: [1, 0.3, 1] },}, variant(), undefined, {duration: 0.4, ease: "easeInOut"})}
                ...
                />
                <Motion.path
                  animate={resolveValues({normal: { scale: 1, opacity: 1 },
                    animate: { scale: [1, 0.3, 1], opacity: [1, 0.3, 1] },}, variant())}
                  transition={resolveTransition({normal: { scale: 1, opacity: 1 },
                    animate: { scale: [1, 0.3, 1], opacity: [1, 0.3, 1] },}, variant(), undefined, {duration: 0.4, ease: "easeInOut"})}
