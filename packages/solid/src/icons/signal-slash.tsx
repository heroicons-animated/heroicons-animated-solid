...
interface SignalSlashIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: SignalSlashIconHandle) => void;
}
...
const SignalSlashIcon = (rawProps: SignalSlashIconProps) => {
