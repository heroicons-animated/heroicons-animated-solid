...
export interface DocumentArrowDownIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface DocumentArrowDownIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: DocumentArrowDownIconHandle) => void;
}
...
const DocumentArrowDownIcon = (rawProps: DocumentArrowDownIconProps) => {
