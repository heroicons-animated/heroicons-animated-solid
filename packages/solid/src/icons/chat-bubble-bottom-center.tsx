...
interface ChatBubbleBottomCenterIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
...
const ChatBubbleBottomCenterIcon = (rawProps: ChatBubbleBottomCenterIconProps) => {
