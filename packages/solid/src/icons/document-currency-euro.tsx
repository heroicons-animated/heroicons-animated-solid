...
interface DocumentCurrencyEuroIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
...
const DocumentCurrencyEuroIcon = (rawProps: DocumentCurrencyEuroIconProps) => {
