...
export interface LinkSlashIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface LinkSlashIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: LinkSlashIconHandle) => void;
}
...
const LinkSlashIcon = (rawProps: LinkSlashIconProps) => {
