...
interface GlobeAmericasIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: GlobeAmericasIconHandle) => void;
}
...
const GlobeAmericasIcon = (rawProps: GlobeAmericasIconProps) => {
