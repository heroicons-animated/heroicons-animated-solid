...
interface EllipsisHorizontalIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: EllipsisHorizontalIconHandle) => void;
}
...
const EllipsisHorizontalIcon = (rawProps: EllipsisHorizontalIconProps) => {
