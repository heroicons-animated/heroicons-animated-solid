...
interface MagnifyingGlassMinusIconProps
  extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: MagnifyingGlassMinusIconHandle) => void;
}
...
const MagnifyingGlassMinusIcon = (rawProps: MagnifyingGlassMinusIconProps) => {
