...
interface EllipsisHorizontalCircleIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
...
const EllipsisHorizontalCircleIcon = (rawProps: EllipsisHorizontalCircleIconProps) => {
