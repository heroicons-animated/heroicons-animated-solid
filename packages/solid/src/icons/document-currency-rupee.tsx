...
interface DocumentCurrencyRupeeIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
...
const DocumentCurrencyRupeeIcon = (rawProps: DocumentCurrencyRupeeIconProps) => {
