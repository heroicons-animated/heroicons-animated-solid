...
interface ArrowLongDownIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: ArrowLongDownIconHandle) => void;
}
...
const ArrowLongDownIcon = (rawProps: ArrowLongDownIconProps) => {
      ...
      <svg
            ...
            >
              ...
              <Motion.path
                ...
                transition={resolveTransition(LINE_VARIANTS, variant())} d="M12 21V3" />
            </svg>
    </div>
  );
};
