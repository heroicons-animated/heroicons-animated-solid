...
interface ClipboardDocumentListIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
...
const ClipboardDocumentListIcon = (rawProps: ClipboardDocumentListIconProps) => {
              ...
              {LIST_ITEMS.map((item, index) => {
                ...
                return (
                  <g key={item.y}>
                    <Motion.path
                      d={item.dotPath}
                      animate={resolveValues(CREATE_DOT_VARIANTS(dotDelay), variant())}
                      transition={resolveTransition(CREATE_DOT_VARIANTS(dotDelay), variant())}
                    />
                    <Motion.path
                      d={item.linePath}
