...
interface ClipboardDocumentCheckIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
...
const ClipboardDocumentCheckIcon = (rawProps: ClipboardDocumentCheckIconProps) => {
