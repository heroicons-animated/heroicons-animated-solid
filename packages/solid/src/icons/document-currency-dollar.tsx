...
interface DocumentCurrencyDollarIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
...
const DocumentCurrencyDollarIcon = (rawProps: DocumentCurrencyDollarIconProps) => {
