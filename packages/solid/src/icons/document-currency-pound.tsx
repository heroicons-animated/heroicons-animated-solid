...
interface DocumentCurrencyPoundIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: DocumentCurrencyPoundIconHandle) => void;
}
...
const DocumentCurrencyPoundIcon = (rawProps: DocumentCurrencyPoundIconProps) => {
