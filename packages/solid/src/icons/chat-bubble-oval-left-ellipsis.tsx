...
interface ChatBubbleOvalLeftEllipsisIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
...
const ChatBubbleOvalLeftEllipsisIcon = (rawProps: ChatBubbleOvalLeftEllipsisIconProps) => {
