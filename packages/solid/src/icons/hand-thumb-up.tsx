...
export interface HandThumbUpIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface HandThumbUpIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: HandThumbUpIconHandle) => void;
}
...
const HandThumbUpIcon = (rawProps: HandThumbUpIconProps) => {
