...
const RadioIcon = (rawProps: RadioIconProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Motion.g
          animate={resolveValues(SPEAKER_VARIANTS, variant())}
          transition={resolveTransition(SPEAKER_VARIANTS, variant())}
        >
