...
interface UserGroupIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: UserGroupIconHandle) => void;
}

const RIGHT_USER_VARIANTS = {
  normal: {
    translateX: 0,
    opacity: 1,
    transition: {
...
const UserGroupIcon = (rawProps: UserGroupIconProps) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Motion.path
          animate={resolveValues(RIGHT_USER_VARIANTS, variant())}
          ...
          transition={resolveTransition(RIGHT_USER_VARIANTS, variant())}
        />
        <Motion.path
          animate={resolveValues(LEFT_USER_VARIANTS, variant())}
          ...
          transition={resolveTransition(LEFT_USER_VARIANTS, variant())}
        />
      </svg>
    </div>
  );
