...
const ShoppingCartIcon = (rawProps: ShoppingCartIconProps) => {
  ...
  return (
    ...
    >
      <Motion.svg
        animate={resolveValues(CART_VARIANTS, variant())}
        transition={resolveTransition(CART_VARIANTS, variant(), undefined, {duration: 0.2})}
              fill="none"
              height={local.size}
              stroke="currentColor"
