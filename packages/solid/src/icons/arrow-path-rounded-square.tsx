...
interface ArrowPathRoundedSquareIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
...
const ArrowPathRoundedSquareIcon = (rawProps: ArrowPathRoundedSquareIconProps) => {
