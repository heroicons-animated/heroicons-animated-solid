...
interface ReceiptRefundIconProps extends JSX.HTMLAttributes<HTMLDivElement> {
  size?: number;
  ref?: (handle: ReceiptRefundIconHandle) => void;
}
...
const ReceiptRefundIcon = (rawProps: ReceiptRefundIconProps) => {
      ...
      <svg
            ...
            >
              ...
              <Motion.g
                ...
                transition={resolveTransition(ARROW_VARIANTS, variant())} animate={resolveValues(ARROW_VARIANTS, variant())}
