...
const ScissorsIcon = (rawProps: ScissorsIconProps) => {
  ...
  return (
    ...
    >
      <Motion.svg
        animate={resolveValues(SCISSORS_VARIANTS, variant())}
        fill="none"
        height={local.size}
        stroke="currentColor"
        ...
        stroke-width="1.5"
        transition={resolveTransition(SCISSORS_VARIANTS, variant())}
        viewBox="0 0 24 24"
        width={local.size}
