...
export const ClipboardDocumentIcon = (props: JSX.IntrinsicElements["svg"]) => {
  ...
  return (
    <svg
      aria-hidden="true"
      class={cn("size-4 text-neutral-800 dark:text-neutral-100", local.class)}
      fill="none"
      stroke="currentColor"
...
export const MagnifyingGlassIcon = (props: JSX.IntrinsicElements["svg"]) => {
  ...
  return (
    <svg
      aria-hidden="true"
      class={cn("size-5 text-neutral-400", local.class)}
      fill="none"
      stroke="currentColor"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const CheckIcon = (props: JSX.IntrinsicElements["svg"]) => {
  ...
  return (
    <svg
      aria-hidden="true"
      class={cn("size-4 text-green-600", local.class)}
      fill="none"
      stroke="currentColor"
      stroke-linecap="round"
      stroke-linejoin="round"
...
export const XIcon = (props: JSX.IntrinsicElements["svg"]) => {
  ...
  return (
    <svg
      aria-hidden="true"
      class={cn("size-4 text-red-500", local.class)}
      fill="none"
      stroke="currentColor"
      stroke-linecap="round"
      stroke-linejoin="round"
